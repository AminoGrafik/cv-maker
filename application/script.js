document.addEventListener('DOMContentLoaded', function() {
    ...
    function addCard(type) {
        ...
        switch(type) {
            case 'workExperience':
                content = `
                    <div class="form-card-header">
                        ...
                        <span class="chevron"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"></polyline></svg></span>
                    </div>
            ...
            case 'projects':
                content = `
                    <div class="form-card-header"><div class="title">Untitled</div><span class="chevron"><svg...></svg></span></div>
                    <div class="form-card-body">
            ...
            case 'languages':
                content = `
                    <div class="form-card-header"><div class="title">Language</div><span class="chevron"><svg...></svg></span></div>
                    <div class="form-card-body form-card-grid-2">
                        ...
                        <div class="form-group"><label>Proficiency</label><input type="text" class="lang-prof" placeholder="e.g., Native, Fluent"></div>
                    </div>`;
                break;
        }
    ...
    function generateCV() {
        ...
        preview.innerHTML = [headerHTML, summaryHTML, experienceHTML, projectsHTML, educationHTML, certificationsHTML, skillsHTML, languagesHTML].join('');
    }
